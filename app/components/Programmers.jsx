...
const programmers = [
  {
    ...
    social: {
      github: "https://github.com/mmdrezakz",
      telegram: "https://t.me/Mmdreza_kz",
      email: "mailto:mellboy.beat@gmail.com",
    },
  },
  {
    name: "امیر پارسا",
    ...
    resume: "https://example.com/resume.pdf",
    social: {
      github: "https://github.com/maref833-prog",
      telegram: "https://t.me/Arefmoradi20",
      email: "mailto:maref833@gmail.com",
    },
  },
  {
    name: "عارف مرادی",
    ...
    resume: "https://example.com/resume.pdf",
    social: {
      github: "https://github.com/ELAP-sys",
      telegram: "https://t.me/parsaamira",
      email: "mailto:amirparsa793@gmail.com",
    },
  },
];
...
export default function Programmers() {
  return (
    <section
      id="team"
      className="flex justify-center items-center bg-linear-to-b from-gray-100 to-[#002549] w-full"
    >
      <div className="justify-items-center items-center grid grid-cols-1 xl:grid-cols-4 pb-10 max-w-7xl">
        ...
        <div className="right mb-8 text-center xl:text-right">
          <h2 className="mb-4 font-bold text-4xl">
            برنامه نویسان تیم فرا ایده
          </h2>
          <p className="mx-auto xl:mx-0 max-w-96 text-gray-800 text-xl">
            تیم برنامه نویسی ما رو به توسعه میباشد و پیش بینی میگردد طی سال جاری
            تعداد برنامه نویسان ما به بالای پانزده نفر برسد
          </p>
          <div className="mt-6">
            <Image
              width={200}
